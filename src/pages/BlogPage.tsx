...
export const BlogPage = () => {
  ...
  return (
    <Box bg="#F8FAFC" minH="100vh">
      ...
      <Box as="main">
        <Box pt={{ base: "32", md: "40" }} pb={{ base: "16", md: "24" }} bgGradient="linear(to-b, #EEF2FF, #F8FAFC)">
          <Container maxW="7xl">
            <VStack gap="6" align="center" textAlign="center" maxW="3xl" mx="auto">
              <Heading as="h1" fontSize={{ base: "4xl", md: "5xl", lg: "6xl" }} fontWeight="800" color="#0F172A" letterSpacing="-0.03em" lineHeight="1.1">
                Wiedza, która napędza <br />
                <Text as="span" color="#4F46E5">wzrost Twojej firmy</Text>
              </Heading>
              <Text fontSize={{ base: "lg", md: "xl" }} color="#475569" lineHeight="1.8" maxW="2xl">
              ...
              >
                <Box position="relative" overflow="hidden" w={{ base: "full", lg: "50%" }}>
                  <Image 
                    ...
                    objectFit="cover"
                  />
                  <Box position="absolute" top="6" left="6" bg="white" color="#4F46E5" px="4" py="1.5" rounded="full" fontSize="sm" fontWeight="800">
                    Najnowszy wpis
                  </Box>
                </Box>

                <VStack align="start" justify="center" p={{ base: "8", lg: "12" }} gap="6" w={{ base: "full", lg: "50%" }}>
                  <HStack color="#64748B" fontSize="sm" fontWeight="600" gap="4">
                  ...
                  <Heading as="h2" fontSize={{ base: "2xl", md: "3xl" }} lineHeight="1.3" color="#0F172A" fontWeight="800">
                    {blogPosts[0].title}
                  </Heading>
                  
                  <Text color="#475569" lineHeight="1.8" fontSize="lg">
                    {blogPosts[0].excerpt}
                  </Text>

                  <HStack color="#4F46E5" fontWeight="700" gap="2" pt="6">
              ...
              {blogPosts.slice(1).map((post) => (
                ...
                >
                  <Box position="relative" overflow="hidden">
                    ...
                    <Box position="absolute" top="4" left="4" bg="rgba(255, 255, 255, 0.9)" color="#4338CA" px="3" py="1" rounded="full" fontSize="xs" fontWeight="700">
                      {post.category}
                    </Box>
                  </Box>

                  <VStack align="start" p="6" gap="4">
                    <HStack color="#64748B" fontSize="sm" fontWeight="500" gap="4">
                      <Text>{post.date}</Text>
                      <HStack gap="1.5">
                        <FiClock size={12} />
                    ...
                    <Heading as="h2" fontSize="xl" lineHeight="1.4" color="#0F172A" fontWeight="700">
                      {post.title}
                    </Heading>
                    ...
                    <HStack color="#4F46E5" fontSize="sm" fontWeight="600" gap="1" pt="4">
                      <Text>Czytaj</Text>
