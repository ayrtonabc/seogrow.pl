...
const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    situation: "Asesor de seguros de vida certificado MDRT Junior en Olsztyn, con un mercado muy concreto: familias y empresas de toda la región de Warmia y Mazury. Necesitaba una web que transmitiera seriedad profesional (vende seguros, no productos baratos) y que posicionara para búsquedas locales en 8 ciudades de la región, no solo Olsztyn.",
    whatWeDid: "Diseñamos una web bilingüe mental (polaco para el cliente, schema para Google) con estructura dual: cliente individual (familias) vs empresa (protección de socios/empleados). Creamos páginas SEO dedicadas para cada ciudad de la región (Ostróda, Elbląg, Iława, Ełk, Mrągowo, Giżycko, Szczytno). Implementamos schema InsuranceAgency + LocalBusiness + Person con credenciales MDRT visibles. FAQ con las 10 preguntas reales que recibía por WhatsApp. Formulario dual (particular / empresa) con un solo clic para cambiar el tipo de cliente.",
    result: "Sitio en producción, todas las páginas de ciudades indexadas, formulario de consulta gratuita operativo desde el día 1. Schema valida con 4 entidades interconectadas (Person → InsuranceAgency → LocalBusiness → ProfessionalService). Crédito 'Designed by SeoGrow' en el footer como prueba visible del trabajo.",
    resultNote: "Web en producción · wiktorskiubezpieczenia.pl",
  },
  {
