        ...
        <Box display={{ base: "block", lg: "grid" }} gridTemplateColumns={{ lg: "1fr 1fr" }} gap={{ lg: "10", xl: "14" }} alignItems="center">
          ...
          <VStack align={{ base: "center", lg: "flex-start" }} gap={{ base: "5", md: "6" }} textAlign={{ base: "center", lg: "left" }} maxW={{ base: "3xl", lg: "none" }} mx={{ base: "auto", lg: "0" }}>
            ...
            <Heading
              ...
              maxW="640px"
            >
              Strona internetowa, na jaką zasługuje{" "}
            ...
            <Text
              ...
              fontWeight="400"
            >
              Profesjonalna strona z <Box as="span" fontWeight="600" color="fg.default">CMS-em i SEO</Box>, gotowa w 5 dni. Od <Box as="span" fontWeight="600" color="#215AFF">1 500 zł</Box>. Edytujesz ją sam z telefonu.
            </Text>
